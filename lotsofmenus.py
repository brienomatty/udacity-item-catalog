...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     ...
                     The meat is prized for its thin, crisp skin, with \
                     authentic versions of the dish serving mostly the \
                     skin and little meat, sliced in front of the diners \
                     by the cook", price="$25", course="Entree",
...
menuItem5 = MenuItem(user_id=1, name="Beef Noodle Soup",
                     ...
                     or red braised beef, beef broth, vegetables and \
                     Chinese noodles.",
...
menuItem6 = MenuItem(user_id=1, name="Ramen",
                     ...
                     consists of Chinese-style wheat noodles served in \
                     a meat- or (occasionally) fish-based broth, often \
                     flavored with soy sauce or miso, and uses toppings \
                     such as sliced pork, dried seaweed, kamaboko, and \
                     green onions.",
                     price="12", course="Entree", restaurant=restaurant2)
...
menuItem1 = MenuItem(user_id=1, name="Pho",
                     ...
                     of broth, linguine-shaped rice noodles called banh \
...
menuItem1 = MenuItem(user_id=1, name="Tres Leches Cake",
                     ...
                     sweet milk and topped with vanilla bean whipped cream \
                     and strawberries.",
...
menuItem3 = MenuItem(user_id=1, name="Honey Boba Shaved Snow",
                     ...
                     and freshly made mochi", price="$4.50", course="Dessert",
...
menuItem5 = MenuItem(user_id=1, name="Aloo Gobi Burrito",
                     description="Vegan goodness. Burrito filled with \
                     rice, garbanzo beans, curry sauce, potatoes (aloo), \
...
menuItem4 = MenuItem(user_id=1, name="Choc Full O\' Mint Ice cream)",
                     description="Milk, cream, salt, ..., \
                     Liquid nitrogen magic", price="$3.95",
...
menuItem9 = MenuItem(user_id=1, name="Chicken Fried Steak",
                     ...
                     and smothered with cream gravy", price="$8.99",
...
menuItem2 = MenuItem(user_id=1, name="Cachapa",
                     ...
                     Venezuelan pancake; usually stuffed with queso \
                     telita or queso de mano, and possibly lechon. ",
                     price="$7.99", course="Entree", restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Lemon Curd Ice Cream Sandwich",
                     ...
                     and cashews", price="$4.25", course="Dessert",
                     restaurant=restaurant1)
